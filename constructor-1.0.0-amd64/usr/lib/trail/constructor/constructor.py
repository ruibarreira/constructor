...
from trail import IsoUnpack, EditDistro, BuildIso, DistroGeneral
...
gettext.textdomain('constructor')
...
class Constructor(object):
    ...
    def __init__(self):
        ...
        self.shareDir = join(self.scriptDir, '../../../share/trail/constructor')
    ...
    def on_btnIso_clicked(self, widget):
        ...
        filePath = SelectFileDialog(title=_('Select ISO'), start_directory=startDir, parent=self.window, gtkFileFilter=fleFilter).show()
